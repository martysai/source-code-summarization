...
def main(args):
    ...
    def make_all(lang, vocab):
        if args.trainpref:
            ...
            for k, trainpref in enumerate(args.trainpref.split(",")):
                ...
                make_dataset(vocab, trainpref, outprefix, lang, num_workers=args.eval_workers)
    ...
    def make_all_src(lang, vocab):
        if args.trainpref:
            ...
            for k, trainpref in enumerate(args.trainpref.split(",")):
                outprefix = "train{}".format(k) if k > 0 else "train"
                make_dptree_dataset(vocab, trainpref, outprefix, lang, num_workers=args.eval_workers)
